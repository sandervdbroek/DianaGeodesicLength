...
for elementSize in elementSizes:
    ...
    print('Run completed')
    DATfilename = "CShell_125dTh" + str(deltaPhi) + "_dz" + str(deltaZ) + '.dat'
    tbfilename  = "CShell_125dTh" + str(deltaPhi) + "_dz" + str(deltaZ) + '.tb'
    ...
    np.savetxt('CShellOpt1m25.csv', errorArray)
    elementindex += 1
# np.save('FPError',errorArray)